...
<div class="modal fade" id="story-drawing" data-keyboard="false" data-backdrop="static" tabindex="-1">
...
<script type="text/javascript">
	$(document).ready(function () {
	    ...
	    $('.editable-canvas-image').click(function() {
		    var box_draw = $('#redactor-drawer-box');

		    $('#redactor-drawer-box').remove();
	
		    $('#canvas-editor').append(box_draw);
	    });

    	$('#story-drawing').on('shown.bs.modal', function (e) {
